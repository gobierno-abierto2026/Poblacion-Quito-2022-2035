...
* **Diseño, Arquitectura y Desarrollo del Visualizador:** Desarrollado por **Dirección de Gestión de la Información (DMGI)**..
...
2. Navega a la carpeta principal:
   ...
   cd visualizador_web
   ```
3. Abre el archivo `index.html` en cualquier navegador web (Chrome, Edge, Firefox, Safari).
